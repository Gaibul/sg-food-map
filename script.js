...
// Final popup content generator with unified confirm button
...
// One final save function for everything
function saveAll(key) {
    const rating = parseFloat(document.getElementById(`rate_${key}`)?.value);
