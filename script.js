...
window.saveNoteAndPhoto = async function (key) {
    ...
    if (file) {
        ...
        reader.onload = async function(event) {
            ...
            img.onload = async function () {
                ...
                await set(key, compressedData);
                alert("Photo saved in browser storage!");
            };
...
window.loadPhoto = async function (key, container) {
